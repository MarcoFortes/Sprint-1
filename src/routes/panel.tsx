...
export const Route = createFileRoute("/panel")({
  validateSearch: (s: Record<string, unknown>) => ({
    name: typeof s.name === "string" ? s.name : "User",
  }),
  component: PanelPage,
});
    ...
    <div className="min-h-screen bg-muted p-4">
      <div className="max-w-2xl mx-auto bg-card rounded-2xl shadow-xl p-8 border mt-8">
        ...
        <p className="text-lg text-muted-foreground mb-6">
          Welcome, <strong className="text-primary">{name}</strong>
        </p>
        <div className="grid grid-cols-2 gap-4">
          <div className="p-6 bg-primary/10 rounded-xl border-2 border-primary">
            <div className="text-sm text-secondary font-semibold">Balance</div>
          ...
          <div className="p-6 bg-secondary/10 rounded-xl border-2 border-secondary">
            <div className="text-sm text-secondary font-semibold">Trips</div>
